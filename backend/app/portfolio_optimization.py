...
# Use the shared logging configuration instead of creating a custom one
from app.core.logging_config import setup_portfolio_optimization_logger

# Initialize logger using the shared configuration
logger = setup_portfolio_optimization_logger()
